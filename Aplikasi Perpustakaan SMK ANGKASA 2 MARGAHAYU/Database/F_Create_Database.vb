...
Public Class F_Create_Database
    ...
    End Sub
    Sub mati(ByVal ad As Boolean)
        rdDrop.Visible = ad
        rdAppend.Visible = ad
        chkStructure.Visible = ad
        chkData.Visible = ad
        chkDeleteExistingData.Visible = ad
    End Sub
        ...
        Try
            ...
            Else
                If (Not rdDrop.Checked And Not rdAppend.Checked) Then
                    MessageBox.Show("This database already exist.", "Database exists", MessageBoxButtons.OK, MessageBoxIcon.Stop)
    ...
    Sub Import_Database()
        Try
            ...
            Catch
            End Try
            MessageBox.Show("Buat Database Berhasil", "Informasi Database", MessageBoxButtons.OK, MessageBoxIcon.Information)
        Catch ex As Exception
            MessageBox.Show(ex.Message(), "Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
        End Try
    End Sub
